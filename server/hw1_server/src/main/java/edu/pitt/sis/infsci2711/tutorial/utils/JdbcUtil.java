...
public class JdbcUtil {
	...
	public static final String DEFAULT_USER = "can"; //CHANGE TO YOUR MYSQL USER NAME
	
	public static final String DEFAULT_PASSWOD = "626391"; // CHANGE TO YOUR MYSQL PASSWORD
